...
**Starting early:** Garmin polling begins at the configured start time; earlier GPS timestamps are ignored. Change the start time on the private edit page before the first fix is accepted if you plan to leave early. The start time is locked after tracking begins. Scheduled races have no GPS-based ETAs until accepted positions establish a pace.
